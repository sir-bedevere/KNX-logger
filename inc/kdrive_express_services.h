...
extern "C" {
	...
	*/
	kdrive_API int32_t kdrive_sp_create(int32_t ap);
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API bool_t kdrive_sp_release(int32_t sp);
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_set_response_timeout(int32_t sp, uint32_t timeout);
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_get_response_timeout(int32_t sp, uint32_t* timeout);
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_set_co(int32_t sp, bool_t connection_oriented);
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API bool_t kdrive_sp_is_co(int32_t sp);
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_device_descriptor_type0_read(int32_t sp, uint16_t ind_addr,
	...
	*/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_device_descriptor_type2_read(int32_t sp,
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_restart_device_type0(int32_t sp, uint16_t ind_addr);
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_restart_device_type1(int32_t sp,
	        uint16_t ind_addr,
	        uint8_t erase_code,
	...
	*/
	...
	/*!
	      ...
	      \ingroup kdrive_express_services
	 */
	kdrive_API error_t kdrive_sp_property_description_read(int32_t sp,
	        uint16_t ind_addr,
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_prop_value_read(int32_t sp,
	        uint16_t ind_addr,
	        uint8_t object_index,
	        uint8_t prop_id,
	        uint8_t nr_of_elems,
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_prop_value_write(int32_t sp,
	        uint16_t ind_addr,
	        uint8_t object_index,
	        uint8_t prop_id,
	        uint8_t nr_of_elems,
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_prop_value_write_without_verify(int32_t sp,
	        uint16_t ind_addr,
	        uint8_t object_index,
	        uint8_t prop_id,
	        uint8_t nr_of_elems,
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_function_property_command(int32_t sp,
	        uint16_t ind_addr,
	        uint8_t object_index,
	        uint8_t prop_id,
	        const uint8_t input_data[],
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_function_property_state_read(int32_t sp,
	        uint16_t ind_addr,
	        uint8_t object_index,
	        uint8_t prop_id,
	        const uint8_t input_data[],
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_memory_read(int32_t sp,
	        uint16_t ind_addr,
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_memory_write(int32_t sp,
	        uint16_t ind_addr,
	        uint16_t memory_addr,
	        const uint8_t data[],
	        uint32_t data_length);
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_memory_write_without_verify(int32_t sp,
	        uint16_t ind_addr,
	        uint16_t memory_addr,
	        const uint8_t input_data[],
	        uint32_t input_data_length,
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_user_memory_read(int32_t sp,
	        uint16_t ind_addr,
	        uint16_t memory_addr,
	        uint8_t number,
	        uint8_t data[],
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_user_memory_write(int32_t sp,
	        uint16_t ind_addr,
	        uint16_t memory_addr,
	        const uint8_t data[],
	        uint32_t data_length);
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_user_memory_write_without_verify(int32_t sp,
	        uint16_t ind_addr,
	        uint16_t memory_addr,
	        const uint8_t input_data[],
	        uint32_t input_data_length,
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_authorize_request(int32_t sp,
	        uint16_t ind_addr,
	        uint32_t key,
	        uint8_t* level);
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_key_write(int32_t sp,
	                                       uint16_t ind_addr,
	                                       uint32_t key,
	                                       uint8_t* level);
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_load_state_read(int32_t sp,
	        uint16_t ind_addr,
	        uint8_t object_index,
	        uint8_t* load_state);
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_load_state_write(int32_t sp,
	        uint16_t ind_addr,
	        uint8_t object_index,
	        uint8_t load_event,
	        uint8_t* load_state);
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_load_state_write_ex(int32_t sp,
	        uint16_t ind_addr,
	        uint8_t object_index,
	        uint8_t load_event,
	...
	*/
	kdrive_API error_t kdrive_sp_read_prog_mode(int32_t sp,
	        uint16_t ind_addr,
	        bool_t* enabled);
	...
	*/
	kdrive_API error_t kdrive_sp_read_prog_mode_property_based(int32_t sp,
	        uint16_t ind_addr,
	        bool_t* enabled);
	...
	/*!
		...
		\sa kdrive_sp_read_prog_mode
	*/
	kdrive_API error_t kdrive_sp_read_prog_mode_memory_mapped(int32_t sp,
	        uint16_t ind_addr,
	        bool_t* enabled);
	...
	*/
	kdrive_API error_t kdrive_sp_switch_prog_mode(int32_t sp,
	        uint16_t ind_addr,
	        bool_t enable);
	...
	*/
	kdrive_API error_t kdrive_sp_switch_prog_mode_property_based(int32_t sp,
	        uint16_t ind_addr,
	        bool_t enable);
	...
	/*!
		...
		\sa kdrive_sp_switch_prog_mode
	*/
	kdrive_API error_t kdrive_sp_switch_prog_mode_memory_mapped(int32_t sp,
	        uint16_t ind_addr,
	        bool_t enable);
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_memory_block_read(int32_t sp,
	        uint16_t ind_addr,
	        uint16_t* memory_addr,
	        uint8_t number,
	        uint8_t data[],
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_memory_block_write(int32_t sp,
	        uint16_t ind_addr,
	        uint16_t memory_addr,
	        const uint8_t data[],
	        uint32_t data_length);
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_ind_addr_prog_mode_read(int32_t sp,
	        uint32_t wait_time,
	        uint16_t data[],
	        uint32_t* data_length);
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_ind_addr_prog_mode_write(int32_t sp, uint16_t new_ind_addr);
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_ind_addr_sn_read(int32_t sp,
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_ind_addr_sn_write(int32_t sp,
	        const uint8_t sn[KDRIVE_SN_LEN],
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_network_param_write_broadcast(int32_t sp,
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_network_param_write_systembroadcast(int32_t sp,
	        uint16_t object_type,
	        uint8_t prop_id,
	        const uint8_t data[],
	        uint32_t data_length);
	...
	*/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_domain_addr_prog_mode_read(int32_t sp,
	        uint32_t wait_time,
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_domain_addr_prog_mode_write(int32_t sp, const uint8_t da[KDRIVE_DA_LEN]);
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_domain_addr_sn_read(int32_t sp,
	        const uint8_t sn[KDRIVE_SN_LEN],
	        uint16_t* ind_addr,
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_services
	*/
	kdrive_API error_t kdrive_sp_domain_addr_sn_write(int32_t sp,
	        const uint8_t sn[KDRIVE_SN_LEN],
