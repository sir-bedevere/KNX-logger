...
/*!
	...
	\author Copyright (c) 2002-2014 WEINZIERL ENGINEERING GmbH
...
#define KDRIVE_MAX_DEVICE_NAME_LEN		(31) /*!< The max length of a device friendly name; (inclusive 1 byte for zero)*/
...
extern "C" {
	...
	*/
	kdrive_API int32_t kdrive_ap_create(void);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API bool_t kdrive_ap_release(int32_t ap);
	...
	********************************/
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API uint32_t kdrive_ap_enum_usb(int32_t ap);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_open_usb(int32_t ap, uint32_t iface_index);
	...
	*/
	typedef struct ip_tunn_dev_t
	{
		...
		char dev_name[KDRIVE_MAX_DEVICE_NAME_LEN]; /*< device friendly name. Null-terminated string*/
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_enum_ip_tunn(int32_t ap,
	        ip_tunn_dev_t items[],
	...
	/*!
		...
		\param [in] ap the access port descriptor
		\param [in] ip_address The IP Address in the form "192.168.1.47" for example
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_open_ip(int32_t ap, const char* ip_address);
	...
	/*!
		...
		\param [in] ap the access port descriptor
		\param [in] ip_address The IP Address in the form "192.168.1.47" for example
		\param [in] iface_address The Interface Adaptor IP Address
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_open_ip_ex(int32_t ap, const char* ip_address, const char* iface_address);
	...
	********************************/
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_open_serial_ft12(int32_t ap, const char* serial_device);
	...
	********************************/
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_open_tiny_serial(int32_t ap, const char* serial_device);
	...
	********************************/
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_close(int32_t ap);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API bool_t kdrive_ap_is_open(int32_t ap);
	...
	********************************/
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_send(int32_t ap, const uint8_t telegram[], uint32_t telegram_len);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_group_write(int32_t ap, uint16_t address, const uint8_t* value, uint32_t bits);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_group_read(int32_t ap, uint16_t address);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_group_response(int32_t ap, uint16_t address, const uint8_t* value, uint32_t bits);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API uint32_t kdrive_ap_read_group_object(int32_t ap, uint16_t address,
	...
	********************************/
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_enable_queue(int32_t ap, bool_t enabled);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API uint32_t kdrive_ap_receive(int32_t ap,
	                                      uint8_t telegram[], uint32_t telegram_len, uint32_t timeout);
	...
	********************************/
	...
	/*!
		...
		\param [in] ap the access port descriptor
		\param [out] telegram holds the received telegram, the buffer is temporary
		\param [out] telegram_len indicates the length of the telegram
		\ingroup kdrive_express_access
	*/
	typedef void (*kdrive_ap_telegram_callback)(const uint8_t telegram[], uint32_t telegram_len);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_register_telegram_callback(int32_t ap,
	        kdrive_ap_telegram_callback c, uint32_t* key);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_remove_telegram_callback(int32_t ap, uint32_t key);
	...
	********************************/
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_get_dest(const uint8_t telegram[],
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_get_src(const uint8_t telegram[],
	                                     uint32_t telegram_len, uint16_t* address);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_get_apci(const uint8_t telegram[],
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_get_message_code(const uint8_t telegram[],
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_get_serial_number(const uint8_t telegram[],
	...
	********************************/
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API bool_t kdrive_ap_is_group(const uint8_t telegram[], uint32_t telegram_len);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API bool_t kdrive_ap_is_group_write(const uint8_t telegram[], uint32_t telegram_len);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API bool_t kdrive_ap_is_group_read(const uint8_t telegram[], uint32_t telegram_len);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API bool_t kdrive_ap_is_group_response(const uint8_t telegram[], uint32_t telegram_len);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_get_group_data(const uint8_t telegram[],
	...
	********************************/
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_get_ind_addr(int32_t ap, uint16_t* address);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_set_ind_addr(int32_t ap, uint16_t address);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_get_rf_domain_addr(int32_t ap, uint8_t da[KDRIVE_DA_LEN]);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_set_rf_domain_addr(int32_t ap, const uint8_t da[KDRIVE_DA_LEN]);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_get_serial_no(int32_t ap, uint8_t sn[KDRIVE_SN_LEN]);
	...
	*/
	kdrive_API error_t kdrive_ap_set_serial_no(int32_t ap, const uint8_t sn[KDRIVE_SN_LEN]);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_get_tunnel_ind_addr(int32_t ap, uint16_t* address);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_set_tunnel_ind_addr(int32_t ap, uint16_t address);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_get_additional_ind_addr(int32_t ap, uint16_t addresses[], uint32_t* addresses_len);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_set_additional_ind_addr(int32_t ap, const uint16_t addresses[], uint16_t addresses_len);
	...
	********************************/
	...
	/*!
		Starts the Packet Trace, write Rx and Tx packets to the
		logger (level: information)
		\param [in] ap the access port descriptor
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_packet_trace_connect(int32_t ap);
	...
	/*!
		...
		\ingroup kdrive_express_access
	*/
	kdrive_API error_t kdrive_ap_packet_trace_disconnect(int32_t ap);
