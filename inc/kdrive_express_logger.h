...
extern "C" {
	...
	*/
	kdrive_API void kdrive_logger_set_level(uint8_t level);

	/*!
		Sets the logger to write to the console
		\ingroup kdrive_express_logger
	*/
	kdrive_API void kdrive_logger_console(void);
	...
	/*!
		...
		\ingroup kdrive_express_logger
	*/
	kdrive_API void kdrive_logger_file(void);
	...
	/*!
		...
		\ingroup kdrive_express_logger
	*/
	kdrive_API void kdrive_logger_file_ex(const char* filename);
	...
	/*!
		...
		\ingroup kdrive_express_logger
	*/
	kdrive_API void kdrive_logger(uint8_t level, const char* message);
	...
	/*!
		...
		\ingroup kdrive_express_logger
	*/
	kdrive_API void kdrive_logger_ex(uint8_t level, const char* fmt, ...);
	...
	/*!
		...
		\ingroup kdrive_express_logger
	*/
	kdrive_API void kdrive_logger_dump(uint8_t level, const char* message, const void* buffer, uint32_t buffer_len);
