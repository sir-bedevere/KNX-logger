...
extern "C" {
	...
	*/
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_get_dpt_descriptor(char* dpt_id, datapoint_type_t* dpt_desc);
	...
	***************************************************************/
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt1(uint8_t* data,
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_decode_dpt1(const uint8_t* data,
	        uint32_t length, bool_t* value);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt2(uint8_t* data,
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_decode_dpt2(const uint8_t* data,
	        uint32_t length, bool_t* control, bool_t* value);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt3(uint8_t* data,
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_decode_dpt3(const uint8_t* data,
	        uint32_t length, bool_t* control, uint8_t* value);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt4(uint8_t* data,
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_decode_dpt4(const uint8_t* data,
	        uint32_t length, uint8_t* character);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt5(uint8_t* data,
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_decode_dpt5(const uint8_t* data,
	        uint32_t length, uint8_t* value);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt6(uint8_t* data,
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_decode_dpt6(const uint8_t* data,
	        uint32_t length, int8_t* value);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt7(uint8_t* data,
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_decode_dpt7(const uint8_t* data,
	        uint32_t length, uint16_t* value);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt8(uint8_t* data,
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_decode_dpt8(const uint8_t* data,
	        uint32_t length, int16_t* value);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt9(uint8_t* data,
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_decode_dpt9(const uint8_t* data,
	        uint32_t length, float32_t* value);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt10_local(uint8_t* data, uint32_t* length);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt10_utc(uint8_t* data, uint32_t* length);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt10(uint8_t* data, uint32_t* length,
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_decode_dpt10(const uint8_t* data, uint32_t length,
	        int32_t* day, int32_t* hour, int32_t* minute, int32_t* second);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt11_local(uint8_t* data, uint32_t* length);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt11_utc(uint8_t* data, uint32_t* length);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt11(uint8_t* data, uint32_t* length,
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_decode_dpt11(const uint8_t* data, uint32_t length,
	        int32_t* year, int32_t* month, int32_t* day);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt12(uint8_t* data,
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_decode_dpt12(const uint8_t* data,
	        uint32_t length, uint32_t* value);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt13(uint8_t* data,
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_decode_dpt13(const uint8_t* data,
	        uint32_t length, int32_t* value);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt14(uint8_t* data,
	        uint32_t* length, float32_t value);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_decode_dpt14(const uint8_t* data,
	        uint32_t length, float32_t* value);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt15(uint8_t* data, uint32_t* length,
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_decode_dpt15(const uint8_t* data, uint32_t length,
	        int32_t* accessCode, bool_t* error, bool_t* permission,
	        bool_t* direction, bool_t* encrypted, int32_t* index);
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_encode_dpt16(uint8_t* data,
	...
	/*!
		...
		\ingroup kdrive_express_dpt
	*/
	kdrive_API error_t kdrive_dpt_decode_dpt16(const uint8_t* data,
